            ...
            </div>
            {
              currentUser.id == sender.id ? (
                <div className="edit-mode">
                  ...
                  <img className="message-recall-btn" src="https://img.icons8.com/external-solid-style-bomsymbols-/65/000000/external-bin-business-shop-finance-solid-style-set-2-solid-style-bomsymbols-.png" alt="recall"/>
                  {
                    editMode ? (
